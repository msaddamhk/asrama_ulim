                    ...
                    <div class="card-header bg-black text-white">
                        <div class="d-flex">
                            ...
                            <div class="mx-2 my-auto">
                                <h6 class="m-0 my-auto" style="font-size: 13px">Daftar Akun</h6>
                                <p class="my-auto" style="font-size: 11px">Silahkan lengakapi data Anda</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="">
                                        <input id="no_hp" type="text" class="form-control" name="no_hp"
                                            pattern="^62\d{9,}$" placeholder="Contoh: 628123456789"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="">
                                        <input id="nama_bapak" type="text"
                                            ...
                                            name="nama_bapak" value="{{ old('nama_bapak') }}" required
